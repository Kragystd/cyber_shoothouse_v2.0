...
class ShootingRange:
    ...
    def process_frame(self, frame):
        ...
        return [cam_marked, real_target_display, hitpoint, score]
    ...
    def hit_feedback(self, hitpoint: tuple):
        ...
        # sound_back(score)
        self.hitpoint_list.append((hitpoint, score))
