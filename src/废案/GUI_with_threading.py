...
class Ui_HomePage_customed(Ui_HomePage):
    ...
    def retranslateUi_customed(self, HomePage, clickedEventList):
        ...
        self.playBGV = threading.Thread(target=self.update_frame)
        self.playBGV.start()
    ...
    def update_frame(self):
        ...
        while True:
            ...
            if self.threadingKiller is True:
                return
...
class Ui_PlayPage_customed(Ui_PlayPage):
    ...
    def retranslateUi_customed(self, PlayPage, clickedEventList):
        ...
        self.update_frame_threading = threading.Thread(target=self.update_frame,
                                                       args=(self.shootingRange.getCurrentData(),))
...
class mainWindow(QMainWindow):
    ...
    def quitAll(self):
        ...
        self.ui[0].threadingKiller = True
